                ...
                <Link to="/resources">
                  ...
                  >
                    ...
                    >
                      ...
                      {isActive("/resources") && (
                        <motion.div 
                          className="absolute bottom-0 left-0 h-0.5 bg-[#E64833] w-full"
                          initial={{ scaleX: 0 }}
                          animate={{ scaleX: 1 }}
                          transition={{ duration: 0.3 }}
                        />
            ...
            <DropdownMenu open={isMenuOpen} onOpenChange={setIsMenuOpen}>
              ...
              <DropdownMenuContent align="end" className="w-[200px] bg-white dark:bg-[#1E3A47] p-2">
                ...
                <DropdownMenuItem className="mt-2">
                  <Link to="/auth" className="flex w-full bg-[#244855] text-white px-3 py-2 rounded-md font-medium text-center" onClick={() => setIsMenuOpen(false)}>
                    Login / Sign Up
                  </Link>
                </DropdownMenuItem>
              </DropdownMenuContent>
