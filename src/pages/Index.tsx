...
const Index = () => {
  ...
  const fullText = "Transforming Your College Experience";
    ...
    <div className="flex flex-col min-h-screen" ref={topRef}>
      ...
      <section className="py-16 bg-[#FBE9D0]/30 dark:bg-[#1E3A47]/30">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold font-heading text-center mb-12 text-[#244855] dark:text-white">
            Powerful Features That Make a Difference
          </h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="border-none shadow-lg hover:shadow-xl transition-shadow duration-300 dark:bg-[#1E3A47] interactive-card">
              <CardContent className="pt-6">
                ...
                <h3 className="text-xl font-bold font-heading mb-2 text-[#244855] dark:text-white">Smart Learning</h3>
            ...
            <Card className="border-none shadow-lg hover:shadow-xl transition-shadow duration-300 dark:bg-[#1E3A47] interactive-card">
              <CardContent className="pt-6">
                ...
                <h3 className="text-xl font-bold font-heading mb-2 text-[#244855] dark:text-white">Unified Dashboard</h3>
            ...
            <Card className="border-none shadow-lg hover:shadow-xl transition-shadow duration-300 dark:bg-[#1E3A47] interactive-card">
              <CardContent className="pt-6">
                ...
                <h3 className="text-xl font-bold font-heading mb-2 text-[#244855] dark:text-white">AI Assistant</h3>
            ...
            <Card className="border-none shadow-lg hover:shadow-xl transition-shadow duration-300 dark:bg-[#1E3A47] interactive-card">
              <CardContent className="pt-6">
                ...
                <h3 className="text-xl font-bold font-heading mb-2 text-[#244855] dark:text-white">Collaboration Tools</h3>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="bg-[#244855] rounded-2xl overflow-hidden shadow-xl group">
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="p-8 md:p-12 flex flex-col justify-center">
                <h2 className="text-3xl font-bold font-heading mb-4 text-white">Explore Our Campus</h2>
                ...
                <div>
                  <Button
                    ...
                    className="inline-flex items-center justify-center rounded-md bg-[#E64833] px-5 py-2.5 text-sm font-medium text-white shadow hover:bg-[#d13e2b] hover:scale-105 transition-transform focus:outline-none focus:ring-2 focus:ring-[#E64833] focus:ring-offset-2 group-hover:animate-pulse-gentle"
                  >
                    Take a Virtual Tour
                  </Button>
                </div>
      ...
      <section className="py-16 bg-[#90AEAD]/10 dark:bg-[#1A3641]/30">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold font-heading mb-4 text-[#244855] dark:text-white">Ready to Transform Your College Experience?</h2>
          ...
          <Link to="/auth">
            <Button className="bg-[#E64833] hover:bg-[#d13e2b] text-white px-8 py-6 text-lg hover:scale-105 transition-all duration-300">
              Get Started Today
            </Button>
          </Link>
        </div>
